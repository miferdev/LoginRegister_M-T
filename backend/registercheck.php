...
if ($checkMail->num_rows > 0) {
    ...
    $conn->query("INSERT INTO CLIENTE (nombre, contrasenia, email, telefono, direccion_envio, 
    ciudad, codigo_postal) VALUES ('$nombre', '$contrasenia', 
    '$correo', '$telefono', '$direccion', '$ciudad', '$codigoPostal')");
